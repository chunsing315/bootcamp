...
import com.bootcamp.bc_forum_tutorial.model.UserPlaceHolder.AddressDTO.GeoDTO;
...
public class Mapper {
    ...
    public UserDTO map(UserEntity userEntity) {
        ...
        GeoDTO geoDTO = GeoDTO.builder()//
                .lng(userEntity.getAddressEntity().getGeo().getLng())//
                .lat(userEntity.getAddressEntity().getGeo().getLng()).build();
    ...
    // public com.bootcamp.bc_forum.model.UserDTO.CommentDTO mapToDTO(CommentEntity
    // commentEntity){
